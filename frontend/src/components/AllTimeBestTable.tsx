 ...
 *
 * Each row navigates to the owning session's detail page on click.
 */
    ...
    <div>
      ...
      <div className="flex flex-col">
        {laps.map((l) => (
          <button
            key={l.uid}
            onClick={() => navigate(`/sessions/${l.sessionUid}`)}
            className="grid grid-cols-[1fr_140px_140px_120px] items-center gap-3 border-b border-border/50 py-2 text-left text-[13px] transition-colors last:border-b-0 hover:bg-surface-hover"
          >
