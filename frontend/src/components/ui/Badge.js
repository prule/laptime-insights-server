...
export function Badge({ type }) {
    ...
    return (_jsx("span", { className: `inline-flex items-center rounded font-mono text-[10px] font-semibold uppercase tracking-[0.1em] px-[7px] py-[3px] ${style.className}`, children: style.label }));
}
