...
Define browser-level end-to-end testing for the React frontend: a Playwright harness driven through the Serenity/JS Screenplay pattern, run against the app in MOCK data mode, and gated in CI.
