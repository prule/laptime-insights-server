...
/**
 * Inbound port invoked when a car model becomes known (its `EntryListCar` is processed), to attribute
 * that model to laps already recorded car-less for the same session + car index.
 */
