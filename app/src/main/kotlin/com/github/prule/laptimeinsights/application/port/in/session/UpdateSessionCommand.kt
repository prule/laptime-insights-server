 ...
 *
 * The driving caller is `ClientInitializer`, which builds up `track` and `car` incrementally as ACC
 * telemetry arrives — at any given moment one or both may not yet be known (`null`). Those unknown
 * values must NOT clobber what's already persisted, hence the leave-alone semantic.
 *
