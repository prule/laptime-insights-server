...
data class SessionOptionsResource(
  ...
  companion object {
    fun fromDomain(options: SessionOptions, linkFactory: SessionOptionsLinkFactory): SessionOptionsResource =
...
class SessionOptionsLinkFactory(private val application: Application) : LinkFactory<SessionOptions> {
