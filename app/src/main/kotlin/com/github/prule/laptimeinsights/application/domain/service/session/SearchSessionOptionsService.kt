...
class SearchSessionOptionsService(private val searchSessionPort: SearchSessionPort) :
  SearchSessionOptionsUseCase {
  override fun options(criteria: SessionSearchCriteria): SessionOptions = transaction {
    searchSessionPort.options(criteria)
  }
}
