...
//    install(CallLogging)
    ...
    val createSessionUseCase = CreateSessionService(SessionPersistenceAdapter(SessionRepository(mapper), mapper))

    CreateSessionController(this, createSessionUseCase)
}
